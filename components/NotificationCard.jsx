			...
			{isExpended && (
				<View style={style.containContainer}>
					<Text style={style.content}>
						...
						molestias hic ducimus. Dolore molestiae reprehenderit error ipsam
						temporibus laboriosam vero obcaecati suscipit libero illum natus,
						distinctio laborum nesciunt autem?
					</Text>
				</View>
			)}
		</View>
